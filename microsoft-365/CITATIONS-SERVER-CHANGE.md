...
None. The Microsoft 365 package in this folder doesn't change, and Copilot reads the new fields automatically at runtime. Once it's deployed, we'll confirm the citations show up in Copilot before resubmitting.
